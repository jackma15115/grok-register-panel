    ...
    <div class="help-view-inner">
      ...
      <div id="help-faq" role="tabpanel" aria-labelledby="help-tab-faq" hidden>
        ...
        <div class="faq-grid" id="faq-grid">
          ...
          <details class="faq-item" data-faq-item data-search="邮箱服务 provider cloudflare duckmail yyds mailnest cloudmail moemail ti temp mail outlook_rt inbucket 自建 jsonl refresh_token api 测试 域名轮换">
